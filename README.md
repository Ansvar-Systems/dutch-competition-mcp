# Dutch Competition MCP

**Dutch competition data for AI compliance tools.**
...
**Endpoint:** `https://mcp.ansvar.eu/dutch-competition/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add dutch-competition-mcp --transport http https://mcp.ansvar.eu/dutch-competition/mcp` |
...
```json
{
  "mcpServers": {
    "dutch-competition-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/dutch-competition/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/dutch-competition-mcp
```
...
```json
{
  "mcpServers": {
    "dutch-competition-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/dutch-competition-mcp"]
    }
  }
}
```
...
| Tool | Description |
|------|-------------|
| `nl_comp_search_decisions` | Full-text search across ACM enforcement decisions (abuse of dominance, cartel, sector inquiries). Returns matching de... |
| `nl_comp_get_decision` | Get a specific ACM decision by case number (e.g., |
| `nl_comp_search_mergers` | Search ACM merger control decisions. Returns merger cases with acquiring party, target, sector, and outcome. |
| `nl_comp_get_merger` | Get a specific ACM merger control decision by case number (e.g., |
| `nl_comp_list_sectors` | List all sectors with ACM enforcement activity, including decision counts and merger counts per sector. |
| `nl_comp_about` | Return metadata about this MCP server: version, data source, coverage, and tool list. |
...
```bash
git clone https://github.com/Ansvar-Systems/dutch-competition-mcp
cd dutch-competition-mcp
npm install
npm run build
npm test
```
